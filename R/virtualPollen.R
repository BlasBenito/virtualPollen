...
#'
#' A dataframe with 16 rows and 16 columns with the parameters of two virtual taxa. It was generated by \code{\link{parametersDataframe}} and \code{\link{fixParametersTypes}}. It is meant to be used as input for \code{\link{simulatePopulation}}. It's columns are:
#'
#' \itemize{
...
#'
#' A list of dataframes with 16 slots, output of \code{\link{simulatePopulation}}, taking \code{\link{parameters}} and \code{\link{drivers}} as input. Each dataframe has the following columns:
#'
#' \itemize{
